...
namespace Project
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=TUF-A17\\SQLEXPRESS;Initial Catalog=Project;Integrated Security=True;Encrypt=False");
        ...
        {
            using (SqlConnection localCon = new SqlConnection("Data Source=TUF-A17\\SQLEXPRESS;Initial Catalog=Project;Integrated Security=True;Encrypt=False"))
            {
                try
                {
                    localCon.Open();
